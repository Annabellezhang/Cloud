(function()
{
	...
	spsupport.api = {
		...
		init: function(){
            ...
            if (testBucket == '2014w38_vulcun_ads' && location.host === "play.google.com")
            {
		...
		jQLoaded: function() {
			...
			if (similarproducts.b.enableCars && similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList() &&  similarproducts.b.userData.uc == 'US')
			{
		...
		requestCouponsWl: function() {
            if(similarproducts.utilities.isUnitActive('ads') || similarproducts.utilities.isUnitActive('vulcon')) {
