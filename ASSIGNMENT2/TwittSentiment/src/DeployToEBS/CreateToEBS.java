...
public class CreateToEBS {
	...
	public static void main(String[] args) throws Exception {
   	 ...
   	 AWSCredentials credentials = new PropertiesCredentials(
   			CreateToEBS.class.getResourceAsStream("AwsCredentials.properties"));
   	 	...
   	 	// # Create an applicationVersion
   	 		...
   	 		CreateApplicationVersionRequest cavRequest = new CreateApplicationVersionRequest()
   	 				...
   	 				.withSourceBundle(new S3Location("assignmentone-zhang-liu", "TwitterMap.war"))
   	 		...
   	 		cer.withApplicationName("AssignmentOne")
   	 			...
   	 			//.withTier(tier)
   	 			.withVersionLabel("TwitterMap")
   	 			.withSolutionStackName("64bit Amazon Linux 2014.09 v1.0.0 running Tomcat 8 Java 8");
