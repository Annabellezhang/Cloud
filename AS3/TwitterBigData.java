...
public class TwitterBigData {
        ...
        InterruptedException{
            if (key.get() > 0) {
                try {
                    ...
                    Date dt = formatter.parse(lines[1]);
                    formatter.applyPattern("HH");
                    
                    String dtstr = formatter.format(dt);
                    
                    context.write(new Text(dtstr+'\t'+sentiments), new IntWritable(1));
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(TwitterBigData.class);
